...
- **Game Over System:** Triggers when balance drops below ₦5M, displays detailed expense breakdown. Single "Continue (Ad)" button (30-second ad simulation) that: keeps current balance, returns invested money, adds ₦50M bonus, wipes all purchased items.
